...
// Almacenar los datos
if($boton=="Guardar"){
	$sql="insert into alumcarnet( Cedula, idNacion, Nombres, Apellidos, idSexo, telefono, correo, FechaReg) 
	values('$Cedula', '$idNacion', '$Nombres', '$Apellidos', '$idSexo', '$telefono', '$correo', '$FechaReg')";
...
if($boton=="Eliminar"){
	...
	if($Cedula!=""){
		$sql="delete from alumcarnet where Cedula='$Cedula'";
		if (mysql_query($sql)){

				echo '<script src="bootstrap-3.3.7/js/jquery-3.2.1.min.js"></script>
					  <script>$(document).ready(function() {swal({ title:"Buen trabajo!!!",text:"Datos ELIMINADOS Correctamente",type:"success"}).then(function() {window.location.href = "Registro-Estudiantes.php";})});</script>';
		}
	}else{
	...
	if($Cedula!=""){
            ...
            $sql="update alumcarnet set Cedula='$Cedula', idNacion='$idNacion', Nombres='$Nombres', Apellidos ='$Apellidos', idSexo='$idSexo', telefono='$telefono', correo='$correo' where Cedula='$Cedula'";
						...
						if(mysql_query($sql)){
										...
										echo '<script src="bootstrap-3.3.7/js/jquery-3.2.1.min.js"></script>
					  							<script>$(document).ready(function() {swal({ title:"Buen trabajo!!!",text:"Datos Modificados Correctamente",type:"success"}).then(function() {window.location.href = "Registro-Estudiantes.php";})});</script>';
...
<nav class="navbar navbar-default">
	       	...
	       	<div class="container-fluid">
	       				...
	       				<br>
												<form class="form-horizontal" action="" method="post" id="FormRegEstu">
												<!-- Datos de los Estudiantes -->
													<div class="row form-group">
														...
														<div class="col-md-5">
															<input type="text" class="form-control" name="Cedula" placeholder="Cedula" value="<?php echo $Cedula;  ?>" id="Cedula">
...
<script type="text/javascript">
             $(document).ready(function () {
                 ...
                 $('#sidebarCollapse').on('mousemove', function (e) {     
                  ...
                  $("#FormRegEstu #Nacion").val("<?php echo $idNacion; ?>");
                  $("#FormRegEstu #idSexo").val("<?php echo $idSexo; ?>");
             });
...
$(document).ready(function(){
	...
	$("#Cedula").keyup(function(e){
		 ...
		 //hace la búsqueda
		 $("#Existe").delay(100).queue(function(n) { 

				$.ajax({
					type: "POST",
					url: "Cedula-Estudiantes.php",
					data: "Cedula="+Cedula,
					error: function(){
...
<script type="text/javascript">
    ...
    var nacion = document.getElementById("Nacion").selectedIndex;
