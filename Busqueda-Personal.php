...
date_default_timezone_set('America/Caracas');
	...
	$Nombres = $_POST['Nombres'];
				...
				$sql = ("select personalcarnet.CedulaPerso as Cedula, nacion.Nacion as Nacionalidad, personalcarnet.Nombres, personalcarnet.Apellidos, sexo.Sexo, personalcarnet.telefono as Telefono,personalcarnet.correo As Correo ,cargo.Cargo, tipocargo.NomTipoCarg as Tipo, regcarnetper.FechaSol, regcarnetper.FechaEntre, estatus.Estatus from personalcarnet 
					INNER JOIN regcarnetper ON personalcarnet.CedulaPerso = regcarnetper.CedulaPerso
					INNER JOIN nacion ON personalcarnet.idNacion = nacion.idNacion
					INNER JOIN sexo ON personalcarnet.idSexo = sexo.idSexo
					...
					INNER JOIN estatus ON regcarnetper.idEstatus = estatus.idEstatus
				 	where personalcarnet.CedulaPerso LIKE '$Buscador%' OR 
				 	      personalcarnet.Nombres LIKE '$Buscador%'");
...
<nav class="navbar navbar-default">
	       	...
	       	<div class="container-fluid">
	       		<h2 class="text-center">Busqueda Personal</h2>
	       				<br>
	       				<form class="form-horizontal" action="" method="post" id="BuscarRegPerso" name="BuscarRegPerso">
														...
														<div class="col-md-3">
															<div class="thumbnail">
																<?php
																	...
																	echo '<img src="'.$directorio.'/'.$CedulaPerso.'.png">';
														
																?>
							
															      <div class="caption">
															        <h3 class="text-center">Datos Personales</h3>
															        <p>Cedula:</p> <label><?php echo $CedulaPerso; ?></label><br>
