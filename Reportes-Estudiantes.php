...
<nav class="navbar navbar-default">
	       	...
	       	<div class="container-fluid">
	       		<h2 class="text-center">Reporte de Carnet Estudiantes</h2>
	       				<br>
												<form class="form-horizontal" action="Planilla-Control-Estudiantes.php" method="post" name="FormReportEstu">
												<!-- Entrada de Productos -->
													<div class="row form-group">
														...
														<div class="col-md-5">
															<input type="date" class="form-control" name="fechaMin" id="fechaMin">
	       											...
	       											<div class="row form-group">
														...
														<div class="col-md-5">
															<input type="date" class="form-control" name="fechaMax" id="fechaMax">
															<span class="help-block"></span>
														</div>
													</div>
			                    					<div class="row form-group">
													...
													<div class="col-md-12">	
															...
															<button type="submit" class="btn btn-info" id="Ver" name="boton"><i class="glyphicon glyphicon-eye-open"></i> Ver</button>
...
function FinalSesion() {
 ...
 <script type="text/javascript">
    	var FormReportEstu = document.getElementById("FormReportEstu");
    	window.onload = iniciar;

    function iniciar(){

    		document.getElementById("Ver").addEventListener('click', validacion, false);
    ...
    function ValidaEstatus(){
    	...
    	idEstatus = document.getElementById("idEstatus").selectedIndex;
    	if( idEstatus== null || idEstatus == 0 ) {
    		$("#IcoValida").remove();
    		$("#idEstatus").parent().parent().attr("class", "form-group has-error has-feedback");
			$("#idEstatus").parent().children("span").text("Debe seleccionar un Estatus");
