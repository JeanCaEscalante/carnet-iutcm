...
// Almacenar los datos
	if($boton=="Guardar"){
			...
			if (mysql_query($salida)){
		 	...
		 	$sql="update regcarnetalum set FechaEntre='$FechaEntre', FechaVen='$FechaV', idEstatus='$idEstatus' where Cedula='$Cedula' and idEstatus = 1 and FechaVen is NULL and FechaEntre is NULL";
			if(mysql_query($sql)){
				...
				mysql_query($consulta);
						  ...
						  echo '<script>setTimeout(function(){swal({title:"Buen trabajo!!!",text:"Datos Guardados",type:"success"}, 
																function(isConfirm){location.href="Entrega-Carnet.php";});}, 100);</script>';
