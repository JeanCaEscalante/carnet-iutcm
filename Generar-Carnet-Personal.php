...
if (isset($_POST['busca'])) {
		...
		$sql = ("select personalcarnet.CedulaPerso, personalcarnet.Nombres, personalcarnet.Apellidos, cargo.Cargo, tipocargo.NomTipoCarg ,formatcarnet.FormatCarnet from personalcarnet 
			INNER JOIN regcarnetper ON personalcarnet.CedulaPerso = regcarnetper.CedulaPerso
			INNER JOIN cargo ON cargo.CodCargo = regcarnetper.CodCargo
            INNER JOIN tipocargo ON tipocargo.idTipoCarg = regcarnetper.idTipoCarg
            INNER JOIN formatcarnet ON formatcarnet.idFormato = tipocargo.idFormato

		 	where personalcarnet.CedulaPerso ='$CedulaPerso'");
...
<!-- sweetalert -->
  ...
  <!-- CSS -->
 	...
 	<link rel="stylesheet" href="css/estilocarnetPerso.css">
  <!-- Javascript -->
    <script src="bootstrap-3.3.7/js/jquery-3.2.1.min.js"></script>
...
<nav class="navbar navbar-default">
	       	...
	       	<div class="container-fluid">
	       				<h2 class="text-center">Generar Carnet Personal</h2>
	       				<br>
	       							...
	       							<div class="row form-group">
														...
														<div class="col-md-5">
																<div class="input-group">
									                    			<input type="text" class="form-control search-query" name="CedulaPerso" placeholder="Cedula"  id="Cedula">
													...
													<div class="carnet text-center" id="Carnet" style="display: none;">
														...
														<div class="Nombres">
															<label><?php echo FormatoNombre($Nombres);?></label><br>
														</div>
														<div class="Apellidos">
															<label><?php echo FormatoNombre($Apellidos); ?></label>
														</div>
														<div class="Cedula">
															<label><?php echo number_format($CedulaPerso, 0, "" , ".");?></label>
														</div>
														<div class="Foto">
															<?php
															$directorio = 'Fotos/Foto-Personal';
															echo '<img src="'.$directorio.'/'.$CedulaPerso.'.png"  height="150" width="154">';
															?>
														</div>
														<div class="Cargo">
															<label><?php echo $Cargo ?></label>
														</div>

														<div class="Valido">
															<label><?php echo $FechaV    ?></label>
														</div>
